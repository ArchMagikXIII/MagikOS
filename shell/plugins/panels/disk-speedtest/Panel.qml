...
// magikos-disk-speedtest run streams both phases and cleans up after itself,
...
Item {
  ...
  function dismiss() {
    if (shell && typeof shell.hide === "function")
      shell.hide((manifest && manifest.id) || "magikos.disk-speedtest")
    else close()
  }
  ...
  Process {
    id: proc
    command: ["magikos-disk-speedtest"]
  ...
  SpeedTestOverlay {
    ...
    layerNamespace: "magikos-disk-speedtest"
    title: root.diskName
    leftLabel: "READ"
    rightLabel: "WRITE"
    unit: "MB/s"
