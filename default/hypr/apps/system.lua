...
o.window(
  "(org.magikos.btop|org.magikos.terminal|org.magikos.bash|org.codeberg.dnkl.foot|org.gnome.NautilusPreviewer|org.gnome.Evince|Magikos|About|TUI.float|imv|mpv)",
  {
    tag = "+floating-window",
  }
)
...
-- This size only covers the first launch: magikos-launch-about measures the
-- rendered content, remembers the size that hugs it, and applies that as its own
-- rule before every later launch.
o.window("org.magikos.about", { float = true })
o.window("org.magikos.about", { center = true })
o.window("org.magikos.about", { size = { 920, 480 } })
...
o.window("org.magikos.screensaver", { fullscreen = true })
o.window("org.magikos.screensaver", { float = true })
o.window("org.magikos.screensaver", { animation = "slide" })
