...
class TranscodeAction(GObject.GObject, Nautilus.MenuProvider):
    def _launch_transcode(self, paths):
        wrapper = shutil.which("magikos-launch-floating-terminal-with-presentation")
        binary = shutil.which("magikos-transcode")
    ...
    def _make_item(self, paths):
        ...
        item = Nautilus.MenuItem(
            name="MagikosTranscodeNautilus::transcode",
            label=label,
    ...
    def _tools_available(self):
        return bool(
            shutil.which("magikos-launch-floating-terminal-with-presentation")
            and shutil.which("magikos-transcode")
        )
