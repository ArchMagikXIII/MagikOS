...
locate_config_script="$MAGIKOS_PATH/install/config/locate.sh"
...
as_root env MAGIKOS_UPDATEDB_CONF_PATH="$UPDATEDB_CONF_PATH" bash -euo pipefail "$locate_config_script"
