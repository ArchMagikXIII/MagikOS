...
# the user-level tool paths there so remote editors and agent CLIs find
# mise-managed installs. @{HOME} expands per-user from passwd. Keep the
...
# Magikos: give SSH commands and other non-shell logins the user-level tool paths
