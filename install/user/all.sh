run_logged "$MAGIKOS_INSTALL/user/theme.sh"
run_logged "$MAGIKOS_INSTALL/user/chromium.sh"
run_logged "$MAGIKOS_INSTALL/user/git.sh"
run_logged "$MAGIKOS_INSTALL/user/xcompose.sh"
run_logged "$MAGIKOS_INSTALL/user/mise-work.sh"

run_logged "$MAGIKOS_INSTALL/user/hardware/asus/fix-audio-mixer.sh"
