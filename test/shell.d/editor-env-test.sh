...
[[ $editor == "magikos-launch-editor --inline" ]] || fail "bash env provides a default editor" "actual: $editor"
...
[[ $sudo_editor == "magikos-launch-editor --inline" ]] || fail "sudo uses the default editor" "actual: $sudo_editor"
