...
# real one rethemes the session it runs in: compositor config reload against
# the live session, gsettings against the live desktop, and a global Node install.
